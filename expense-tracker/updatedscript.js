...
function updateCharts() {
    ...
    // === REPLACE THIS PART WITH GOOGLE CHARTS ===
    drawGooglePieChart(categoryData);
    // === END OF REPLACEMENT ===
    
    // KEEP ALL YOUR EXISTING TREND CHART CODE BELOW (Chart.js)
    // Trend chart data (last 6 months)
    const months = [];
    const monthlyTotals = [];
    
    for (let i = 5; i >= 0; i--) {
        // ... keep all your existing trend chart code exactly as it is
    }
    
    // Trend chart (Chart.js) - KEEP THIS CODE
    const trendCtx = document.getElementById('trend-chart');
    if (trendCtx) {
        // ... keep all your existing trend chart code
    }
}

// === ADD THIS NEW FUNCTION AT THE BOTTOM OF YOUR SCRIPT ===
function drawGooglePieChart(categoryData) {
    ...
    google.charts.setOnLoadCallback(function() {
        ...
        const options = {
            ...
            colors: ['#4361ee', '#3a86ff', '#fb5607', '#8338ec', '#06d6a0', 
